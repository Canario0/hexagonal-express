  ...
  implements CartItemViewRepository
{
  ...
  public whenFindByProductAndCartReturn(cartItem: CartItemView | null) {
    this.mockFindByProductAndCart.mockResolvedValue(cartItem);
  }
  ...
  public async findByProductAndCart(
    ...
    return this.mockFindByProductAndCart(productId, cartId);
  }
}
